...
void setup_motor(){
    ...
    mcpwm_comparator_set_compare_value(cmpr_r,motor.motor_r.duty);
    mcpwm_new_comparator(oper,&mcpwm_new_comparator_cfg,&cmpr_l);
    mcpwm_comparator_set_compare_value(cmpr_l,motor.motor_l.duty);
...
void mot_on(short duty_r, short duty_l) {
    mcpwm_comparator_set_compare_value(cmpr_r, duty_r);
    mcpwm_comparator_set_compare_value(cmpr_l, duty_l);
}
