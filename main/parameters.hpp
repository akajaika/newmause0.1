...
//物�?�?なパラメータ
#define TIRE_DIAMETER	(13.26)				//タイヤの直�?	[mm]
...
#define REF_SEN_R	1260				//マウスを迷路中央に置�?た時のセンサの値
#define REF_SEN_L	1080			//マウスを迷路中央に置�?た時のセンサの値

#define TH_SEN_R	450				//壁があるか否か�?�閾値	車体を区画の左へ�?せた時�?�センサ値(壁あ�?)
#define TH_SEN_L	450				//壁があるか否か�?�閾値	車体を区画の右へ�?せた時�?�センサ値(壁あ�?)
#define TH_SEN_FR	40				//壁があるか否か�?�閾値	
#define TH_SEN_FL	15				//壁があるか否か�?�閾値

#define CONTH_SEN_R	TH_SEN_R			//制御をかけるか否か�?�閾値
#define CONTH_SEN_L	TH_SEN_L			//制御をかけるか否か�?�閾値
#define CON_WALL_KP	(6.0)				//壁センサによる姿勢制御の比例制御の比例定数
...
#define SPEED_KD	(0.1)				//Dゲイン　
//車体中�?における回転方向速度に関するフィードバ�?クゲイン
#define OMEGA_KP	(55.0)				//Pゲイン
#define OMEGA_KI	(0.3)				//Iゲイン
#define OMEGA_KD	(120.0)				//Dゲイン

//走行パラメータ
#define SEARCH_SPEED	(0.3)				//探索走行�?�速度	[m/s]
#define SEARCH_ACCEL	(0.7)				//探索走行�?��?速度	[m/s^2]
...
//迷路関連パラメータ
#define GOAL_X	1   	//ゴール座�?(x)
#define GOAL_Y  0		//ゴール座�?(y)
